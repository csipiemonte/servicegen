 ...
 * @generated
 */
public class ServiceImplItemProvider
	 ...
	 * @generated
	 */
	public ServiceImplItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceImpl_provides_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceImpl_provides_feature", "_UI_ServiceImpl_type"),
				 ServicegenPackage.Literals.SERVICE_IMPL__PROVIDES,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ServiceImpl"));
	}
