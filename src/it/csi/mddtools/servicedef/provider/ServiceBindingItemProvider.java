...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.servicedef.ServiceBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceBindingItemProvider
	 ...
	 * @generated
	 */
	public ServiceBindingItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ServiceBinding)object).getCodBinding();
		return label == null || label.length() == 0 ?
			getString("_UI_ServiceBinding_type") :
			getString("_UI_ServiceBinding_type") + " " + label;
	}
