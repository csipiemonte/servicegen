...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.servicedef.Param} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicedefPackage.Literals.PARAM__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicedefPackage.Literals.PARAM__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConstraintPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Param_constraint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Param_constraint_feature", "_UI_Param_type"),
				 ServicedefPackage.Literals.PARAM__CONSTRAINT,
				 true,
				 false,
				 true,
				 null,
