...
public class RoleImpl extends EObjectImpl implements Role {
	...
	protected EClass eStaticClass() {
		return ServicedefPackage.Literals.ROLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicedefPackage.ROLE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicedefPackage.ROLE__NAME:
				return getName();
		}
