 ...
 * </p>
 * <ul>
 *   <li>{@link it.csi.mddtools.servicedef.impl.BaseTypesImpl#getBaseTypes <em>Base Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BaseTypesImpl extends EObjectImpl implements BaseTypes {
	...
	protected EClass eStaticClass() {
		return ServicedefPackage.Literals.BASE_TYPES;
	}
	...
	public EList<Type> getBaseTypes() {
		if (baseTypes == null) {
			baseTypes = new EObjectContainmentEList<Type>(Type.class, this, ServicedefPackage.BASE_TYPES__BASE_TYPES);
		}
		return baseTypes;
	}
