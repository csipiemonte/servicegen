...
public class ServicedefAdapterFactory extends AdapterFactoryImpl {
	...
	protected ServicedefSwitch<Adapter> modelSwitch =
		new ServicedefSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSDDocumentation(SDDocumentation object) {
				return createSDDocumentationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link it.csi.mddtools.servicedef.SDDocumentation <em>SD Documentation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
