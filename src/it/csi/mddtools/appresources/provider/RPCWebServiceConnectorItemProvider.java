		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RPCWebServiceConnector_selector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RPCWebServiceConnector_selector_feature", "_UI_RPCWebServiceConnector_type"),
				 AppresourcesPackage.Literals.RPC_WEB_SERVICE_CONNECTOR__SELECTOR,
				 true,
				 false,
				 true,
				 null,
