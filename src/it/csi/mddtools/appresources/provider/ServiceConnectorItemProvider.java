...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.appresources.ServiceConnector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceConnectorItemProvider
	 ...
	 * @generated
	 */
	public ServiceConnectorItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Service Def feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addServiceDefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceConnector_serviceDef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceConnector_serviceDef_feature", "_UI_ServiceConnector_type"),
				 AppresourcesPackage.Literals.SERVICE_CONNECTOR__SERVICE_DEF,
				 true,
				 false,
				 true,
				 null,
...
//				 null));
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AppresourcesPackage.Literals.SERVICE_CONNECTOR__SELECTOR);
		}
	...
	public String getText(Object object) {
		String label = ((ServiceConnector)object).getCode();
		return label == null || label.length() == 0 ?
			getString("_UI_ServiceConnector_type") :
			getString("_UI_ServiceConnector_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AppresourcesPackage.Literals.SERVICE_CONNECTOR__SELECTOR,
				 AppresourcesFactory.eINSTANCE.createServiceSelector()));
	}
