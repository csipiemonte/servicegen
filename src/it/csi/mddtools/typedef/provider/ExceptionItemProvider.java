...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.typedef.Exception} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExceptionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Exception_exceptionType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Exception_exceptionType_feature", "_UI_Exception_type"),
				 TypedefPackage.Literals.EXCEPTION__EXCEPTION_TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(it.csi.mddtools.typedef.Exception.class)) {
