...
public class EnumLiteralImpl extends EObjectImpl implements EnumLiteral {
	...
	protected EClass eStaticClass() {
		return TypedefPackage.Literals.ENUM_LITERAL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypedefPackage.ENUM_LITERAL__NAME, oldName, name));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypedefPackage.ENUM_LITERAL__VALUE, oldValue, value));
	}
