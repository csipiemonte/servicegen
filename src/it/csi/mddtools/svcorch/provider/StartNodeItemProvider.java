...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.svcorch.StartNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StartNode_next_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StartNode_next_feature", "_UI_StartNode_type"),
				 SvcorchPackage.Literals.START_NODE__NEXT,
				 true,
				 false,
				 true,
				 null,
